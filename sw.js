...
self.addEventListener('push', (e) => {
  ...
  e.waitUntil(self.registration.showNotification(d.title || 'Stuckato', { body: d.body || '', icon: '/icon-192.png', badge: '/icon-192.png', data: { url: d.url || '/' }, tag: 'practicigo-morning' }));
});
